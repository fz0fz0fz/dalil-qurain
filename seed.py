...
CATEGORIES = [
    # الخدمات الشخصية - يدخل بياناته بنفسه
    {
    ...
    # عمال الصيانة - غالبًا يُدخل عنهم شخص وسيط
    {
    ...
    # فئات ثابتة - مثال جاهز حسب ما أرسلته
    {
...
with app.app_context():
    ...
    db.session.commit()
    print("تم إنشاء الجداول وإضافة الفئات الأساسية بنجاح.")
